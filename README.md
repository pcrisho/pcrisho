...
Soy estudiante de Ingeniería Empresarial y de Sistemas cursando el 7mo ciclo, apasionado(a) por la tecnología y el desarrollo de software. Me encanta construir soluciones que impacten positivamente a las personas y mejorar continuamente mis habilidades técnicas.
...
- 🔧 **Sistema de Gestión de Plantillas**: Desarrollado con HTML, CSS Y JS. 
...
### Desarrollo Web
- HTML, CSS, Tailwind, NextJs, React

### Bases de Datos
- MySQL, SQL Server, MongoDB, Firebase

### Herramientas
- Git, GitHub, Figma, Visual Studio Code, Jira
